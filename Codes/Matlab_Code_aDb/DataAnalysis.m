...
[pks_DCS_smooth,locs_DCS_smooth]=findpeaks(dcs_1_smooth./max(dcs_1_smooth),'MinPeakHeight',0.45);
...
Difference=locs_ECG_smooth-locs_DCS_smooth;
...
dcs_1_smooth2=circshift(dcs_1_smooth,Difference(1)*2)
