...
%         ylabel("% change in Pulse Amplitude");
    ...
    x_pc = (1:1:l)/20;
    plot(x_pc,squeeze(per_change(j,1,30:end-10)),'DisplayName','per_change_dcs_25');
    hold on;
    plot(x_pc,squeeze(per_change(j,2,30:end-10)),'DisplayName','per_change_dcs_15');
    plot(x_pc,squeeze(per_change(j,3,30:end-10)),'DisplayName','per_change_dcs_1');
    plot(x_pc,squeeze(per_change(j,4,30:end-10)),'DisplayName','per_change_dcs_2');
    hold off;
...
% %         
        ...
        env_diff_smooth(i,:) = smooth(env_diff(i,:),300);
