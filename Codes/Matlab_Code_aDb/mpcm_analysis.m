...
% Read files;
dcs_dir = "C:\Users\Jignesh\OneDrive - The University of Western Ontario\Research\Data\MPCM Study\DCS\20220218 - 4\Data.mat" ;     % Directory for DCS data
...
[mx,my] = max(y);
snr_val = zeros(1,5);
snr_val(1) = db2mag(snr(s(1:800),20));
snr_val(2) = db2mag(snr(s(800:1200),20));
snr_val(3) = db2mag(snr(s(1200:4900),20));
snr_val(4) = db2mag(snr(s(4900:5400),20));
snr_val(5) = db2mag(snr(s(5400:6000),20));
