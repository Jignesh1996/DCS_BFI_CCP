...
j =1;
[ens_avg_sig,~,ensemble_curve] = ensemble_avg(ecg1(strt_time(j)*1000:stp_time(j)*1000),dcs_1lp(1,strt_time(j)*20:stp_time(j)*20),400,1);
a_1 = ensemble_curve;
j =4;
[ens_avg_sig,~,ensemble_curve] = ensemble_avg(ecg1(strt_time(j)*1000:stp_time(j)*1000),dcs_1lp(1,strt_time(j)*20:stp_time(j)*20),400,1);
a_2 = ensemble_curve;
j =1;
[ens_avg_sig,~,ensemble_curve] = ensemble_avg(ecg1(strt_time(j)*1000:stp_time(j)*1000),dcs_25lp(1,strt_time(j)*20:stp_time(j)*20),400,1);
a_3 = ensemble_curve;
j =4;
[ens_avg_sig,~,ensemble_curve] = ensemble_avg(ecg1(strt_time(j)*1000:stp_time(j)*1000),dcs_25lp(1,strt_time(j)*20:stp_time(j)*20),400,1);
a_4 = ensemble_curve;
